...
// Define an object that contains overlays. This will be visible at all times.
let overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data){
    ...
    // Create function to determine the color of the circle based on the magnitude of the earthquake.
